"""Configuration dataclasses for Graph-JEPA v3.

The v3 package keeps the patch-based JEPA backbone from v2, but trains the edge
head as a graph-revision model: recover hidden true edges and reject injected
schema-valid false edges.
"""
