"""Train Graph-JEPA v3 with graph-revision supervision."""
...
CHECKPOINT_NAME = "graph_jepa_v3.pt"
...
def train(args) -> Path:
    ...
    with open(out_dir / "config_v3.json", "w") as f:
...
def build_arg_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Train Graph-JEPA v3")
    p.add_argument(
        "--data",
